...
const ANIMA_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'attn_mode', type: 'select', label: 'Attention \u5b9e\u73b0', desc: '\u7559\u7a7a\u81ea\u52a8\u9009\u62e9\uff1bFlashAttention \u8fd0\u884c\u65f6\u4f18\u5148 FA2\u3002', defaultValue: '', options: ['', 'torch', 'xformers', 'sageattn', 'flash'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'sample_sampler', type: 'select', label: '\u91c7\u6837\u5668', defaultValue: 'euler', options: ['ddim', 'pndm', 'lms', 'euler', 'euler_a', 'heun', 'dpm_2', 'dpm_2_a', 'dpmsolver', 'dpmsolver++'], visibleWhen: when('enable_preview', true) },
  ...
  },
  {
    ...
    fields: [
      { key: 'lulynx_experimental_core_enabled', type: 'boolean', label: '\u542f\u7528 Lulynx \u5b9e\u9a8c\u6838\u5fc3', defaultValue: false },
      ...
      { key: 'lulynx_block_weight_enabled', type: 'boolean', label: '\u542f\u7528 BlockWeight (28\u5c42)', defaultValue: false, visibleWhen: when('lulynx_experimental_core_enabled', true) },
      { key: 'lulynx_anima_block_lr_weights', type: 'textarea', label: 'Anima \u5206\u5c42\u6743\u91cd', desc: '\u5171 28 \u5c42\uff0cblocks.0~blocks.27\u3002', defaultValue: ANIMA_BLOCK_WEIGHTS_28, visibleWhen: all(when('lulynx_experimental_core_enabled', true), when('lulynx_block_weight_enabled', true)) },
      { key: 'lulynx_anima_llm_adapter_lr_weight', type: 'number', label: 'LLM Adapter \u5b66\u4e60\u7387\u500d\u7387', defaultValue: 1.0, step: 0.01, visibleWhen: all(when('lulynx_experimental_core_enabled', true), when('lulynx_block_weight_enabled', true)) },
      { key: 'lulynx_anima_final_layer_lr_weight', type: 'number', label: 'final_layer \u5b66\u4e60\u7387\u500d\u7387', defaultValue: 1.0, step: 0.01, visibleWhen: all(when('lulynx_experimental_core_enabled', true), when('lulynx_block_weight_enabled', true)) },
      { key: 'lulynx_anima_norm_lr_weight', type: 'number', label: 'Norm \u5c42\u5b66\u4e60\u7387\u500d\u7387', defaultValue: 1.0, step: 0.01, visibleWhen: all(when('lulynx_experimental_core_enabled', true), when('lulynx_block_weight_enabled', true)) },
