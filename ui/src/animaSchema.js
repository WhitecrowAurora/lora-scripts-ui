...
const ANIMA_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'sample_sampler', type: 'select', label: '\u91c7\u6837\u5668', desc: '当前 Anima 预览只支持 euler / k_euler', defaultValue: 'euler', options: ['euler', 'k_euler'], visibleWhen: when('enable_preview', true) },
